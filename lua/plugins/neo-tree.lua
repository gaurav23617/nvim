return {
	...
	config = function()
		...
		require("neo-tree").setup({
			--------------------------------------------------------------------------------
			-- Additional/Modified General Settings
			--------------------------------------------------------------------------------
			...
			--------------------------------------------------------------------------------
			-- Optional: Source Selector (like AstroNvim)
			--------------------------------------------------------------------------------
			source_selector = {
				winbar = true,
			...
			--------------------------------------------------------------------------------
			-- Default Component Configs (Minimal; no icons added unless you want them)
			--------------------------------------------------------------------------------
			default_component_configs = {
				-- indent = {
				-- 	padding = 0,
				-- 	expander_collapsed = "▸", -- change or remove if you don't want symbols
				-- 	expander_expanded = "▾", -- change or remove if you don't want symbols
				-- },
				-- icon = {
				-- 	-- all set to empty if you don't want any icons at all
				-- 	folder_closed = "",
				-- 	folder_open = "",
				-- 	folder_empty = "",
				-- 	folder_empty_open = "",
